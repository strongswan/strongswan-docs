...
as an index into its kernel-based database to look up up the session keys needed
...
as been introduced by the IKEv2 standard. If the *Initiator* doesn't include an
