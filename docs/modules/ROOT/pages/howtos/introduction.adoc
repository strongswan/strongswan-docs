...
xref:swanctl/swanctl.adoc#_commands[`*swanctl --load-\...*`] commands. Already
...
Using the different xref:swanctl/swanctl.adoc#_commands[`*swanctl --list-\...*`]
...
The xref:swanctl/swanctl.adoc#_commands[`*swanctl --list-\...*`] commands will
