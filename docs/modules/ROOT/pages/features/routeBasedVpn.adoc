...
CAUTION: If the traffic selectors include the IKE traffic to the peer, enabling
         `*install_routes_xfrmi*` requires special care (similarly, if manually
