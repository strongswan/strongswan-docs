...
policy-based VPNs, see xref:install/correctTrafficDump.adoc[Correct Traffic Dump].
...
image:a-m-w-s-b.png[topology,340,129,link={EXVTI},title=net2net-vti example]
...
image:a-m-c-w-d.png[topology,252,129,link={EXSHVTI},title=rw-shared-vti example]
...
image:a-m-w-s-b.png[topology,340,129,link={EXXFRM},title=net2net-xfrmi example]
...
image:a-m-c-w-d.png[topology,252,129,link={EXSHXFRM},title=rw-shared-xfrmi example]
...
image:a-v-m-w-s-b.png[topology,340,129,link={EXMARK},title=net2net-psk-dscp example]
...
image:a-m-w-s-b.png[topology,340,129,link={EXGRE},title=net2net-gre example]
