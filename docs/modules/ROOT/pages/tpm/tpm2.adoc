...
* *tpm2-tss* version 3.1.0: https://github.com/tpm2-software/tpm2-tss/releases/tag/3.1.0
...
https://github.com/tpm2-software/tpm2-tools/tree/5.2/man[here].
...
With the strongSwan xref:pki/pki.adoc[`pki`] tool we can now list the persistent key stored under the handle `*0x81010001*`
...
Debug level 2 shows that xref:pki/pki.adoc[`pki`] extracts the public key from the TPM and converts it into a standard PKCS#1 format:
...
The https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_createek.1.md[`tpm2_createek`]
...
Using the https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_getcap.1.md[`tpm2_getcap`]
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_evictcontrol.1.md[`tpm2_evictcontrol`] command
...
Again using the
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_createek.1.md[`tpm2_createek`]
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_getekcertificate.1.md[`tpm2_getcertificate`] command:
...
Using the xref:pki/pki.adoc[`pki`] tool we can list the downloaded EK certificate belonging to the ECC key:
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_readpublic.1.md[`tpm2_readpublic`]
...
Using the https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_nvreadpublic.1.md[`tpm2_nvreadpublic`]
...
We can use xref:pki/pki.adoc[`pki`] to directly list the properties of the EK certificates:
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_nvread.1.md[`tpm2_nvread`] command:
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_createak.1.md[`tpm2_createak`] command:
...
The xref:pki/pki.adoc[`pki`] tool can directly generate a *PKCS#10* certificate request
...
which was generated in 2016 with the xref:pki/pki.adoc[`pki`] command
...
The https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_nvdefine.1.md[`tpm2_nvdefine`]
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_nvwrite.1.md[`tpm2_nvwrite`] command:
...
https://github.com/tpm2-software/tpm2-tools/blob/5.2/man/tpm2_nvundefine.1.md[`tpm2_nvundefine`] command:
...
The *strongSwan* IKEv2 xref:daemons/charon.adoc[`*charon*`] daemon is started
via `*systemd*`:
...
The connection definition is received by the `*charon-systemd*` daemon triggered by the xref:swanctl/swanctl.adoc[`swanctl --load-conns`] command via the VICI interface
...
The xref:swanctl/swanctl.adoc[`swanctl`] command allows to list the loaded connection definitions
