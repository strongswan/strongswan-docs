...
Please contact us at mailto:{LIC_MAIL}[{LIC_MAIL}] for details if you are
interested.
...
** `*sha1*` ({GITHUB}/tree/master/src/libstrongswan/plugins/sha1[`src/libstrongswan/sha1`])
