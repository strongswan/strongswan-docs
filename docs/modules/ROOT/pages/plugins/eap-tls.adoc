...
image:a-m-c.png[topology,187,129,link={EX1},title=rw-eap-tls-only example]
strongSwan {EX2}[example] showing the use of EAP-TLS only authentication.

image:a-m-c.png[topology,187,129,link={EX2},title=rw-eap-tls-radius example]
