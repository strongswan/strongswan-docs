...
|--enable-ikev1                                               |
|enable *deprecated* IKEv1 protocol support in `charon` daemon
...
|--with-plugins-packaged-separately=YES\|NO
|changes e.g. log messages for distributions that package plugins separately.
 [`no`]
