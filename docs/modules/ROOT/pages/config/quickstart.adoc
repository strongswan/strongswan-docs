...
[cols="2,2,2"]
|===
|*port subrange* |*number of ports in range* |*bit mask*

|`65000-65007` |  `8` |`/29 (0xfffffff8)`

|`65008-65023` | `16` |`/28 (0xfffffff0)`

|`65024-65151` |`128` |`/25 (0xffffff80)`

|`65152-65215` | `64` |`/26 (0xffffffc0)`

|`65216-65247` | `32` |`/27 (0xffffffe0)`

|`65248-65255` |  `8` |`/29 (0xfffffff8)`
|===
